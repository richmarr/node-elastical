...
Client.prototype = {
    ...
    **/
    ...
    /**
    Base URL for this client, of the form "http://host:port". Optionally also provides
    a base path, for hosts that proxy the Elasticsearch API using subdirectories
